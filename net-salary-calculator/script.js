function grossIncome(basicSalary, ...allowances){
	...
	function NHIF(grossPay){
       ...
       document.getElementById("nhif").textContent = "NHIF:" + nhifdeductions
       document.getElementById("nssf").textContent = "NSSF:" + nssfdeductions
       document.getElementById("payee").textContent = "PAYEE:" + payee
